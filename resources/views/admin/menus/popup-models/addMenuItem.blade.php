...
<button id="openModalBtn"
    class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl ml-auto">
...
<div id="menuModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4 hidden">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div class="flex border-b border-gray-200 bg-gray-50">
            <button id="mainMenuTab"
                class="tab-btn flex-1 py-4 px-6 text-sm font-medium transition-all duration-200 text-blue-600 border-b-2 border-blue-600 bg-white">
                Main Menu
            </button>
            <button id="subMenuTab"
                class="tab-btn flex-1 py-4 px-6 text-sm font-medium transition-all duration-200 text-gray-500 hover:text-gray-700">
                Sub Menu
            </button>
        </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-[55px] mt-[55px]">
                        <div>
                            ...
                            <input type="text" id="mainMenuName" name="menu_name"
                        ...
                        <div>
                            ...
                            <input type="text" id="mainMenuUrl" name="url"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                    ...
                    <div>
                        ...
                        <select id="mainMenuStatus" name="status"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="subMenuUrl"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                                placeholder="/products/list" required />
                        </div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('.tab-btn').click(function() {
            ...
            $('.tab-btn').removeClass('text-blue-600 border-b-2 border-blue-600 bg-white').addClass(
        ...
        function resetForms() {
            ...
            $('.tab-btn').removeClass('text-blue-600 border-b-2 border-blue-600 bg-white').addClass(
                'text-gray-500 hover:text-gray-700');
            $('#mainMenuTab').removeClass('text-gray-500 hover:text-gray-700').addClass(
                'text-blue-600 border-b-2 border-blue-600 bg-white');
            $('.tab-content').addClass('hidden');
            $('#mainMenuForm').removeClass('hidden');
        }
